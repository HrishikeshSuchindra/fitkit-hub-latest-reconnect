...
import { ArrowLeft, Calendar, MapPin, Users, Target, Edit2, HelpCircle } from "lucide-react";
    ...
    <div className="min-h-screen bg-muted">
        ...
        <div className="bg-background rounded-2xl p-4 space-y-4">
          ...
          <div className="space-y-3 pl-2">
            <div className="flex items-start gap-3">
              ...
              <span className="text-sm font-medium text-foreground">{venue.name.split(" ")[0]} Tennis</span>
            </div>
            <div className="flex items-start gap-3">
      ...
      <div className="fixed bottom-0 left-0 right-0 p-5 bg-background border-t border-border">
        ...
        <p className="text-xs text-text-tertiary text-center mt-2">
          Your game will go live immediately
        </p>
      </div>
    </div>
  );
