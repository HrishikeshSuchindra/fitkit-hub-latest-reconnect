...
const VenuesRecovery = () => {
  ...
  const venues = {
    spa: [
      ...
      { image: recoverySpa, name: "Tranquil Touch Spa", rating: 4.8, distance: "2.3 km", amenities: ["Swedish", "Reflexology", "Sauna"], price: "₹1000/hr" },
      { image: recoverySpa, name: "Bliss Recovery Center", rating: 4.7, distance: "3.1 km", amenities: ["Sports Massage", "Steam Room", "Jacuzzi"], price: "₹1500/hr" },
    ],
    physio: [
      ...
      { image: recoveryPhysio, name: "Recovery Pro Center", rating: 4.8, distance: "2.6 km", amenities: ["Electrotherapy", "Ultrasound", "Taping"], price: "₹700/session" },
      { image: recoveryPhysio, name: "ActiveLife Physio", rating: 4.7, distance: "3.4 km", amenities: ["Injury Rehab", "Dry Needling", "Massage"], price: "₹900/session" },
    ],
    wellness: [
      { image: recoverySpa, name: "Holistic Wellness Hub", rating: 4.8, distance: "2.1 km", amenities: ["Yoga", "Meditation", "Nutrition"], price: "₹600/session" },
      { image: recoverySpa, name: "Zen Wellness Center", rating: 4.7, distance: "2.9 km", amenities: ["Acupuncture", "Cupping", "Herbal"], price: "₹750/session" },
    ],
  };
  ...
  const allSections = [
    ...
    { title: "Because You Recovered", venues: getAllVenues().slice(3, 7) },
